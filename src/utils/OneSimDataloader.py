...
class DataModule(pl.LightningDataModule):
    ...
    def __init__(self, data_dir= "/gpfs/work/sharmas/mc-snow-data/", 
                 batch_size: int = 256, num_workers: int = 40, transform=None,tot_len=1,test_len=0,sim_num=950):
        super().__init__()
        ...
        #self.inputs=np.load("/gpfs/work/sharmas/mc-snow-data/rel_updates/inputs.npy")
        #self.updates=np.load("/gpfs/work/sharmas/mc-snow-data/rel_updates/updates.npy")
        #self.outputs=np.load("/gpfs/work/sharmas/mc-snow-data/rel_updates/outputs.npy")

        #self.meta=np.load("/gpfs/work/sharmas/mc-snow-data/rel_updates/meta.npy")
        self.arr=None
